...
var I18N_EN = {
  ...
  '从文件导入': 'Import from files',
  '选择 TXT 文件': 'Choose TXT files',
  '选择文件夹': 'Choose folder',
  '可选择一个或多个 TXT，也可以选择整个文件夹；文件内容会替换下方预览': 'Choose one or more TXT files, or an entire folder. File contents replace the preview below.',
  '请输入账号数据': 'Enter account data first',
  '没有找到可读取的 TXT 文件': 'No readable TXT files were found',
  '正在读取文件...': 'Reading files...',
  '已读取 {files} 个文件': 'Read {files} files',
  '忽略 {n} 个非 TXT 文件': 'Ignored {n} non-TXT files',
  '跳过 {n} 个空文件': 'Skipped {n} empty files',
  '当前 {lines} 行，{chars} 个字符': '{lines} lines, {chars} characters',
  '读取文件失败，请重新选择': 'Failed to read the files. Please select them again.',
  '导入结果': 'Import results',
  '新增': 'Added',
  '重复': 'Duplicates',
  '无效': 'Invalid',
  '第 {n} 行': 'Line {n}',
  '没有需要处理的错误行': 'There are no skipped or invalid lines',
  '格式错误，应为四段账号数据': 'Invalid format; expected four account fields',
  '邮箱格式不正确': 'Invalid email format',
  '邮箱过长': 'Email is too long',
  '密码过长': 'Password is too long',
  'Client ID 不能为空': 'Client ID is required',
  'Client ID 过长': 'Client ID is too long',
  'Refresh Token 不能为空': 'Refresh token is required',
  'Refresh Token 过长': 'Refresh token is too long',
  '字段包含无效控制字符': 'A field contains invalid control characters',
  '本次导入中重复': 'Duplicate in this import',
  ...
  // --- Settings page ---
  '配置中心': 'Configuration',
  '让服务按你的方式运行': 'Run the service your way',
  '安全、自动任务与外部集成都集中在这里，修改仅在保存后生效。': 'Manage security, scheduled jobs, and integrations in one place. Changes take effect after saving.',
  'Token 自动刷新': 'Automatic Token Refresh',
  'Telegram 推送': 'Telegram Push',
  '已启用': 'Enabled',
  '未启用': 'Disabled',
  '基础设置': 'Basic Settings',
  '管理站点名称与后台登录凭据。': 'Manage the site name and admin login credentials.',
  '当前状态：{v}': 'Current: {v}',
  '保存基础设置': 'Save Basic Settings',
  'GPTMail 集成': 'GPTMail Integration',
  '用于生成和管理临时邮箱。密钥仅会脱敏显示。': 'Used to create and manage temporary mailboxes. The key is displayed only in masked form.',
  '保存 API Key': 'Save API Key',
  '服务定期检查账号，实际执行由下面的间隔设置控制。': 'The service checks accounts periodically; actual runs are controlled by the interval below.',
  '上次执行': 'Last run',
  '频率与账号安全说明': 'Frequency and account safety',
  '<b>单批限制</b>：为兼容不同运行环境，每批最多刷新 40 个账号，超出的账号会在下一轮处理。':
    '<b>Batch limit</b>: for compatibility across runtimes, each batch refreshes up to 40 accounts; remaining accounts are handled in the next round.',
  '新邮件到达后推送通知，适合及时接收验证码。': 'Push notifications for new messages, useful for receiving verification codes promptly.',
  '先通过 {bot} 获取 Bot Token，给机器人发送一条消息后，再通过 {userinfo} 查询 Chat ID。': 'Get a Bot Token through {bot}, send the bot one message, then look up the Chat ID through {userinfo}.',
  '@BotFather 创建机器人': 'Create a bot with @BotFather',
  '轮询与推送说明': 'Polling and delivery notes',
  '通过<b>轮询</b>实现（非微软实时推送），实际延迟取决于服务检查频率与间隔设置。': 'Uses <b>polling</b> rather than Microsoft real-time push. Actual delay depends on the service check frequency and interval setting.',
  '每轮最多扫描 8 个账号、每账号最多推送 3 条；账号多时按最久未扫描优先轮换。': 'Each round scans up to 8 accounts and pushes up to 3 messages per account; larger sets rotate least-recently-scanned accounts first.',
  '未设置': 'not set',
  ...
  '统计邮件数': 'Count Messages',
  '在后台统计选中账号的邮件数': 'Count the Inbox messages of the selected accounts in the background',
  '将在后台统计选中的 {n} 个邮箱的邮件数，关闭页面也会继续，确认？':
    'This counts the Inbox messages of {n} selected mailboxes in the background and keeps running after you close the page. Continue?',
  '统计中': 'Counting',
  '统计完成': 'Counting complete',
  '已在后台开始刷新，稍后刷新本页查看结果': 'Refresh started in the background - reload this page later to see the result',
  '已在后台开始推送，稍后刷新本页查看结果': 'Push started in the background - reload this page later to see the result',
  '本页 {n} 个': '{n} on this page',
  '检测': 'Check',
  '刷新 Token': 'Refresh Tokens',
  '检测选中': 'Check Selected',
  '在后台刷新选中账号的 Token': 'Refresh the tokens of the selected accounts in the background',
  '在后台检测选中账号（含邮件数统计）': 'Check the selected accounts in the background (including Inbox counts)',
  '将在后台刷新选中的 {n} 个账号的 Token，关闭页面也会继续。失效邮箱会按设置自动删除，确认？':
    'This refreshes the tokens of {n} selected accounts in the background and keeps running after you close the page. Dead mailboxes are deleted according to your settings. Continue?',
  '将在后台检测选中的 {n} 个邮箱，关闭页面也会继续。失效邮箱会按设置自动删除，确认？':
    'This checks {n} selected mailboxes in the background and keeps running after you close the page. Dead mailboxes are deleted according to your settings. Continue?',
  '选中 {n} 个': '{n} selected',
  '已在后台开始': 'Started in the background',
  '成功 {n}': '{n} ok',
  '关闭': 'Dismiss',
...
var SERVER_EN = {
  ...
  '请求必须使用 application/json': 'The request must use application/json',
  '请求体必须是有效 JSON': 'The request body must be valid JSON',
  '请求体必须是 JSON 对象': 'The request body must be a JSON object',
  'account_string 必须是字符串': 'account_string must be a string',
  'group_id 必须是正整数': 'group_id must be a positive integer',
  '账号数据不能为空': 'Account data cannot be empty',
...
var SERVER_EN_PATTERNS = [
  ...
  [/^导入完成：新增 (\d+)，重复 (\d+)，无效 (\d+)$/, 'Import complete: $1 added, $2 duplicates, $3 invalid'],
  ...
  [/^已在后台开始刷新 (\d+) 个邮箱$/, 'Background token refresh started for $1 mailboxes'],
  [/^已在后台开始统计 (\d+) 个邮箱$/, 'Background message count started for $1 mailboxes'],
  [/^已有统计任务在运行，返回当前任务$/, 'A counting job is already running; showing that job'],
  [/^已在后台开始刷新，稍后刷新本页查看结果$/, 'Refresh started in the background - reload this page later to see the result'],
  [/^已在后台开始推送，稍后刷新本页查看结果$/, 'Push started in the background - reload this page later to see the result'],
  [/^已有刷新任务在运行，返回当前任务$/, 'A refresh job is already running; showing that job'],
  [/^单个任务最多 (\d+) 个账号，请分批操作$/, 'A job can cover at most $1 accounts - split it up'],
